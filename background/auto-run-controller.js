        ...
        while (attemptRun <= maxAttemptsForRound) {
          ...
          if (!useExistingProgress) {
            ...
            const keepSettings = {
              ...
              registerExtTaskMode: prevState.registerExtTaskMode,
              plusCheckoutSelectedAccountId: prevState.plusCheckoutSelectedAccountId,
              plusCheckoutSelectedEmail: prevState.plusCheckoutSelectedEmail,
